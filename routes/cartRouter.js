...
import { validateAddCart } from "../controllers/validation/addCart.js";
...
router.post("/", protect, validateAddCart, asyncWrapper(addCartItem));
router.get("/one", protect, asyncWrapper(getCartItem));
router.put("/", protect, asyncWrapper(updateCartItem));
